// CGT 215-Lab8-Evan Yoder.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    Texture redTex;
    LoadTex(redTex, "images/duck_image.png");
    ...
    Text scoreText;
    Font font;
    if (!font.loadFromFile("font/yankclipper2.ttf")) {
        cout << "Couldn't load font yankclipper2.ttf" << endl;
        exit(1);
    }
